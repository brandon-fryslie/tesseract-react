...
class PlaylistsPanel extends React.Component<PlaylistsPanelProps> {
  ...
  @action _setActivePlaylist(value: PlaylistModel | null): void {
  ...
  set activePlaylist(value: PlaylistModel | null) {
  ...
  handlePlaylistClick(dom: React.MouseEvent, playlist: PlaylistModel): void {
    this.activePlaylist = playlist;
  }

  // Handle a drag from the Scene list to the Playlist
  handleSceneDragToPlaylist(source: DraggableLocation, destination: DraggableLocation): void {
    const sourceList = Util.getListForDroppable(source.droppableId) as SceneModel[];
  ...
  handlePlaylistGridReorder(source: DraggableLocation, destination: DraggableLocation): void {
    if (!this.activePlaylist) {
      return;
    }
  ...
  render(): React.ReactNode {
    ...
    let playlistEditor: React.ReactNode;
    if (activePlaylist) {
...
export default observer(PlaylistsPanel as any);
